...
size: M
planned_start: '2024-03-15'
planned_end: '2024-03-16'
...
This guide demonstrates various Markdown features supported in GanttMD tasks.
...
Use `#` for headers. GanttMD supports H1 through H6:
...
[Internal link to another task](../getting-started/2024-01-01-0001_welcome-to-ganttmd/README.md)
...
This guide covers the most commonly used Markdown syntax in GanttMD!
